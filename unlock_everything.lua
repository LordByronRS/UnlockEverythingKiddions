-- Author: ShinyWasabi, gir489, LordByron_, Vega-Punk

local packed_tools = require("./scripts/packed_stats_tools") -- Credits to fangshun2004
...
function unlock_packed_bools(from, to)
    for i = from, to do
        packed_tools.set_packed_bool(i, true)
    end
end
...
menu.add_action("ShinyWasabi", function() --Original script by ShinyWasabi
    local is_player_male = (player.get_player_ped():get_model_hash() == joaat("mp_m_freemode_01"))
    ...
    packed_tools.set_packed_int(7315, 6) --WEAPON_STONE_HATCHET
    packed_tools.set_packed_int(18981, 4) --WEAPON_DOUBLEACTION
    packed_tools.set_packed_int(18982, 3) --Parts of the TM-02 Khanjali (tracks, remote grenade launcher and turret end/muzzle brake)
    packed_tools.set_packed_int(18983, 3) --Parts of the RCV (plow, door and water hose)
    packed_tools.set_packed_int(18984, 3) --Parts of the Chernobog (door, dual headlight set and wheels)
    packed_tools.set_packed_int(18985, 3) --Parts of the Thruster (exhaust, small rotors and handlebars/joysticks)
    packed_tools.set_packed_int(18986, 3) --Parts of the Avenger (wing, nose camera and rotor blade)
    packed_tools.set_packed_int(22050, 5) --Oppressor MK2 Trade Price
    packed_tools.set_packed_int(22051, 50) --Carved Wooden Box (Nightclub)
    packed_tools.set_packed_int(22052, 100) --Ammo Box
    packed_tools.set_packed_int(22053, 20) --Meth
    packed_tools.set_packed_int(22054, 80) --Weed
    packed_tools.set_packed_int(22055, 60) --Passports
    packed_tools.set_packed_int(22056, 40) --Crumpled Cash
    packed_tools.set_packed_int(22057, 10) --Impotent Rage Statue
    packed_tools.set_packed_int(22058, 20) --Gold Business Battle Trophy (Nightclub)
    packed_tools.set_packed_int(22063, 20) --Dinka Go Go Monkey Blista
    packed_tools.set_packed_int(41237, 10) --Taxi Livery
    ...
    stats.set_int(mpx() .. "SR_WEAPON_BIT_SET", 262143)
    ...
    stats.set_int(mpx() .. "NUMBER_SLIPSTREAMS_IN_RACE", 110)
    stats.set_int(mpx() .. "NUMBER_TURBO_STARTS_IN_RACE", 90)
    stats.set_int(mpx() .. "USJS_FOUND", 50)
    stats.set_int(mpx() .. "USJS_COMPLETED", 50)
    stats.set_int(mpx() .. "MPPLY_TIMES_RACE_BEST_LAP", 101)
    stats.set_int(mpx() .. "AWD_FMRALLYWONDRIVE", 25)
    stats.set_int(mpx() .. "AWD_FMWINSEARACE", 25)
    stats.set_int(mpx() .. "AWD_FMWINAIRRACE", 25)
    stats.set_int(mpx() .. "AWD_FM_RACES_FASTEST_LAP", 101)
    ...
    stats.set_int(mpx() .. "AWD_DANCE_TO_TALEOFUS", 360)
    stats.set_int(mpx() .. "AWD_DANCE_TO_DIXON", 360)
    stats.set_int(mpx() .. "AWD_DANCE_TO_BLKMAD", 360)
    stats.set_int("NIGHTCLUB_HOTSPOT_TIME_MS", 40320000)
    ...
    packed_tools.set_packed_bool(25010, true) -- Skip arena wall help.
    packed_tools.set_packed_bool(25014, true) -- Skip arena wall tutorial.
    stats.set_bool(mpx() .. "AWD_DEADEYE", true) -- Badlands Revenge II -- Dead Eye
    stats.set_bool(mpx() .. "AWD_PISTOLSATDAWN", true) -- Badlands Revenge II -- Pistols At Dawn
    stats.set_bool(mpx() .. "AWD_TRAFFICAVOI", true) -- Race and Chase -- Beat the Traffic
    stats.set_bool(mpx() .. "AWD_CANTCATCHBRA", true) -- Race and Chase -- All Wheels
    stats.set_bool(mpx() .. "AWD_WIZHARD", true) -- The Wizard"s Ruin -- Feelin" Grogy
    stats.set_bool(mpx() .. "AWD_APEESCAPE", true) -- Space Monkey 3: Bananas Gone Bad -- Ape Escape
    stats.set_bool(mpx() .. "AWD_MONKEYKIND", true) -- Space Monkey 3: Bananas Gone Bad -- Monkey Mind
    stats.set_bool(mpx() .. "AWD_AQUAAPE", true) -- Monkey Paradise -- Aquatic Ape
    stats.set_bool(mpx() .. "AWD_KEEPFAITH", true) -- Defender of the Faith -- Keeping The Faith
    stats.set_bool(mpx() .. "AWD_TRUELOVE", true) -- The Love Professor -- True Love
    stats.set_bool(mpx() .. "AWD_NEMESIS", true) -- The Love Professor -- Nemesis
    stats.set_bool(mpx() .. "AWD_FRIENDZONED", true) -- The Love Professor -- Friendzoned
    stats.set_bool(mpx() .. "SCGW_WON_NO_DEATHS", true) -- Street Crimes: Gang Wars Edition -- Win a game without taking any damage
    stats.set_bool(mpx() .. "IAP_CHALLENGE_0", true) -- Invade and Persuade II -- Score over 2,000,000 in a single playthrough
    stats.set_bool(mpx() .. "IAP_CHALLENGE_1", true) -- Invade and Persuade II -- Collect 88 barrels in a single playthrough
    stats.set_bool(mpx() .. "IAP_CHALLENGE_2", true) -- Invade and Persuade II -- Kill 100 animals in a single playthrough
    stats.set_bool(mpx() .. "IAP_CHALLENGE_3", true) -- Invade and Persuade II -- Travel 3,474,000km on the moon
    stats.set_bool(mpx() .. "IAP_CHALLENGE_4", true) -- Invade and Persuade II -- Finish any level of Invade and persuade with over 7 livee
    stats.set_bool(mpx() .. "AWD_KINGOFQUB3D", true) -- QUB3D -- King Of QUB3D
    stats.set_bool(mpx() .. "AWD_QUBISM", true) -- QUB3D -- Qubism
    stats.set_bool(mpx() .. "AWD_GODOFQUB3D", true) -- QUB3D -- God Of QUB3D
    stats.set_bool(mpx() .. "AWD_QUIBITS", true) -- QUB3D -- Qubits
    stats.set_bool(mpx() .. "AWD_ELEVENELEVEN", true) -- Axe Of Fury -- 11 11
    stats.set_bool(mpx() .. "AWD_GOFOR11TH", true) -- Axe Of Fury -- Crank It To 11
    stats.set_bool(mpx() .. "AWD_STRAIGHT_TO_VIDEO", true) -- Camhedz -- Straight To Video
    stats.set_bool(mpx() .. "AWD_MONKEY_C_MONKEY_DO", true) -- Camhedz -- Monkey See Monkey Do
    stats.set_bool(mpx() .. "AWD_TRAINED_TO_KILL", true) -- Camhedz -- Trained to Kill
    stats.set_bool(mpx() .. "AWD_DIRECTOR", true) -- Camhedz -- The Director
    stats.set_int(mpx() .. "AWD_SHARPSHOOTER", 40) -- Badlands Revenge II -- Sharpshooter
    stats.set_int(mpx() .. "AWD_RACECHAMP", 40) -- Race and Chase -- Race Champion
    stats.set_int(mpx() .. "AWD_BATSWORD", 1000000) -- The Wizard"s Ruin -- Platinum Sword
    stats.set_int(mpx() .. "AWD_COINPURSE", 950000) -- The Wizard"s Ruin -- Platinum Sword -- Coin Purse
    stats.set_int(mpx() .. "AWD_ASTROCHIMP", 3000000) -- Space Monkey 3: Bananas Gone Bad -- Astrochimp
    stats.set_int(mpx() .. "AWD_MASTERFUL", 40000) -- Penetrator -- Masterful
    stats.set_int(mpx() .. "SCGW_NUM_WINS_GANG_0", 55) -- Street Crimes: Gang Wars Edition -- Win 20 games with character 1
    stats.set_int(mpx() .. "SCGW_NUM_WINS_GANG_1", 56) -- Street Crimes: Gang Wars Edition -- Win 20 games with character 2
    stats.set_int(mpx() .. "SCGW_NUM_WINS_GANG_2", 57) -- Street Crimes: Gang Wars Edition -- Win 20 games with character 3
    stats.set_int(mpx() .. "SCGW_NUM_WINS_GANG_3", 58) -- Street Crimes: Gang Wars Edition -- Win 20 games with character 4
    stats.set_int(mpx() .. "IAP_MAX_MOON_DIST", 2147483647) -- Invade and Persuade II -- Travel 3,474,000km on the moon
    stats.set_int(mpx() .. "LAST_ANIMAL", 108) -- Invade and Persuade II -- Kill 100 animals in a single playthrough
    stats.set_int(mpx() .. "CH_ARC_CAB_CLAW_TROPHY", -1) -- Kitty Claw Trophy
    stats.set_int(mpx() .. "CH_ARC_CAB_LOVE_TROPHY", -1) -- The Love Professor Trophy
    stats.set_int(mpx() .. "AWD_FACES_OF_DEATH", 50) -- Camhedz -- Faces Of Death
    ...
    packed_tools.set_packed_bool(32312, true)
    ...
    packed_tools.set_packed_int(41241, 5) --Allow buying of Chair Shot acid name.
    stats.set_int(mpx() .. "LIFETIME_BKR_SELL_EARNINGS6", 1000000) --Allow buying of Fck Your Sleep acid name.
    packed_tools.set_packed_int(7666, 25) --Fill CEO office with money
    unlock_packed_bools(7553, 7594) --Fill CEO office with junk
    packed_tools.set_packed_int(9357, 4) --Fill Clubhouse with money
